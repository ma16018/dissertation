...
with open(os.path.join(fig_dir, "ks_metrics_corr.txt"), 'w') as logf:
    # Print KS
...
#plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(fig_dir, "Predicted_VaR_test_corr.png"), bbox_inches='tight')
plt.close('all')
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(fig_dir, "Posterior_predictive_ordered_y_square_test_corr.png"), bbox_inches='tight')
plt.close('all')
...
len_x = len(x_array)
prob_matrix = -np.log(np.array([ecdf(np.square(abs_y), x_array) for abs_y in pred_y_matrix]))
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(fig_dir, "Posterior_cdf_square_y_no_zero_skip_corr.png"), bbox_inches='tight')
plt.close('all')
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(fig_dir, "Posterior_cdf_square_y_no_zero_no_skip_corr.png"), bbox_inches='tight')
plt.close('all')
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(fig_dir, "Histogram_posterior_predictive_abs_y_corr.png"), bbox_inches='tight')
