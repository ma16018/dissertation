...
filename = ('../data/simulated/gamma_driven_sv_'
        'T_{}_'
        'eta_{}_'
        'c_{}_'
        'train.pkl'
        .format(T, params['eta'], params['c']))

with open(filename, 'wb') as f:
    pickle.dump(data, f)
    
filename_test = ('../data/simulated/gamma_driven_sv_'
        'T_{}_'
        'eta_{}_'
        'c_{}_'
        'test.pkl'
...
fig_dir = os.path.join('plots', data, 'gamma')
